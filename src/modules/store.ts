...
import listStockReviewSelect from './stock_review/select'
import listStockReviewStatisticsSelect from './stock_review/select'
...
const reducer = combineReducers({
  ...
  listMyStockSelect,
  listStockReviewSelect,
  listStockReviewStatisticsSelect,
