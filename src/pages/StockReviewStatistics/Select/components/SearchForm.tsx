...
import { MY_STOCK_STATUS_OPTIONS, CONTRACT_TYPE_OPTIONS, UPLIMIT_STATUS_OPTIONS, ANALYSIS_STATUS_OPTIONS } from '../consts';
        ...
        <Row>
          <Col flex='1'>
            <Row gutter={[16, 16]}>
              ...
              <Col span={3} xs={12} sm={6} xl={4}>
                <FormItem label='分析类型' name='analysisType'>
                  <Select options={ANALYSIS_STATUS_OPTIONS} placeholder='请选择分析类型' />
                </FormItem>
              </Col>
